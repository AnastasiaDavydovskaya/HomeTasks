package by.tms.lesson45_task2.configiration;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* by.tms.lesson45_task2.services.*Service.*(..))")
    public void services() {}

    @Pointcut("execution(* by.tms.lesson45_task2.repositories.*Repository.*(..))")
