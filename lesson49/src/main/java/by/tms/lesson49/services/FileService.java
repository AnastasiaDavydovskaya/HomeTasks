...
import by.tms.lesson49.exceptions.UploadFailedException;
import by.tms.lesson49.repositories.FileRepository;
...
public class FileService {
    ...
    private final Path RELATIVE_PATH = Path.of("./lesson49");
    ...
    public Resource loadAsResource(Long id) {
        ...
        if (findFile.isPresent()) {
            filename = findFile.get().getFileName();
        }
