...
import by.tms.lesson48.exceptions.UploadFailedException;
import by.tms.lesson48.repositories.FileRepository;
...
public class FileService {
    ...
    private final Path RELATIVE_PATH = Path.of("./lesson48");
